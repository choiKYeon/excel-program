...
/**
 * @summary 예약 주문 상세내용 추가
 */
export const clientReserveOrderControllerUpdateMyReserveOrder = <TData = AxiosResponse<ReserveOrder>>(
    id: string,
    updateReserveOrderDetailDto: UpdateReserveOrderDetailDto, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/olhso/client/me/reserve-order/${id}`,
      updateReserveOrderDetailDto,options
    );
  }
/**
 ...
 * @summary 예약 주문 생성
 */
export const clientReserveOrderControllerCreateMyReserveOrder = <TData = AxiosResponse<ReserveOrder>>(
...
export type ClientReserveOrderControllerUpdateMyReserveOrderResult = AxiosResponse<ReserveOrder>
...
export type ClientReserveOrderControllerCreateMyReserveOrderResult = AxiosResponse<ReserveOrder>
